...
For direct firmware boot on Raspberry Pi 5, see the
[platform build guide](plat/native/rpi5/README.md) and
[platform documentation](plat/native/rpi5/platform-docs.md).
